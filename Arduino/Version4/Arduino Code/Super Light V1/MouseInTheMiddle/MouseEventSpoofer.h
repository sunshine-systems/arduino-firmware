...
class MouseEventSpoofer {
    ...
    private:
        void determineFinalButtonStates(uint8_t usbButtons, uint8_t usbPreviousButtons, uint8_t serialButtons, uint8_t serialPreviousButtons);
